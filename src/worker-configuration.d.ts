/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 566f64ca76df921b988ed9e05021a1e6)
// Runtime types generated with workerd@1.20251118.0 2025-11-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../.svelte-kit/cloudflare/_worker");
	}
	interface Env {
		CF_ZONE_ID: "4a382753cd1dd901db449488cfc14e69";
		CF_AUTH_EMAIL: "entryway.tech@protonmail.com";
		CF_AUTH_KEY: "22b5fbeef44a9e9ac8d2f6e01cbfe8615230f";
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ZONE_ID" | "CF_AUTH_EMAIL" | "CF_AUTH_KEY">> {}
}
